"""This module features the ImplicitRecommender class that performs recommendation using the implicit library."""
...
if __name__ == "__main__":
    ...
    user_artists = load_user_artists(Path("Music-Recommendation-System/lastfmdata/user_artists.dat"))
